...
export default function Sidebar() {
  ...
  return (
    <nav className="w-60 flex-shrink-0 bg-slate-950 text-slate-100 flex flex-col h-screen relative overflow-hidden">
      {/* 装飾的な背景グラデーション */}
      <div
        aria-hidden
      ...
      <div className="relative px-5 py-5 border-b border-white/5">
        <Link href="/dashboard" className="flex items-center gap-3 group">
          <div className="w-10 h-10 rounded-xl bg-gradient-indigo flex items-center justify-center shadow-lg shadow-indigo-500/30 ring-1 ring-white/10 group-hover:scale-105 transition-transform">
            <span className="text-white font-bold text-lg leading-none">N</span>
          </div>
          <div className="leading-tight">
            <p className="text-[11px] text-slate-400 font-medium tracking-wider uppercase">Naoru</p>
